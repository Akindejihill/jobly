...
describe("GET /companies", function () {
  ...
  test("Test get request with query maxEmployees option", async () => {
...
describe("GET /companies/:handle", function () {
  test("works for anon", async function () {
    ...
    expect(resp.body).toEqual(
      {"company": 
        {"description": "Desc1", "handle": "c1", 
        "jobs": 
          [
            {"companyHandle": "c1", "equity": "0.00001", "id": 1, "salary": 98000, "title": "job1"}
          ], 
        "logoUrl": "http://c1.img", "name": "C1", "numEmployees": 1}
    });
  });
    ...
    expect(resp.body).toEqual({
      "company": 
        {"description": "Desc2", "handle": "c2", 
          ...
          "logoUrl": "http://c2.img", "name": "C2", "numEmployees": 2}
    });
  });
